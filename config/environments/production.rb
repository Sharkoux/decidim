...
Rails.application.configure do
  ...
  # Configure les options d'URL par défaut
  config.action_controller.default_url_options = { host: 'localhost', protocol: 'https' }

  # Configure les proxys de confiance (Traefik)
  config.action_dispatch.trusted_proxies = [
    '127.0.0.1',
    '::1',
    'traefik', # Si Traefik est sur le même réseau Docker, sinon ajustez en conséquence
  ]
  ...
  # config.active_job.queue_name_prefix = "CNCPH_production"
